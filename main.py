...
Adittion = Button(cal, padx=16, pady=16, bd=8, fg='black', font=('arial', 20, 'bold'), text='+', bg='orange', command=lambda:btnClick('+')).grid(row=1, column=3)
...
Subtraction = Button(cal, padx=16, pady=16, bd=8, fg='black', font=('arial', 20, 'bold'), text='-', bg='orange', command=lambda:btnClick('-')).grid(row=2, column=3)
...
Multiply = Button(cal, padx=16, pady=16, bd=8, fg='black', font=('arial', 20, 'bold'), text='*', bg='orange', command=lambda:btnClick('*')).grid(row=3, column=3)

#===============================================================
btnDot = Button(cal, padx=16, pady=16, bd=8, fg='black', font=('arial', 20, 'bold'), text='.', bg='powder blue', command=lambda:btnClick('.')).grid(row=4, column=0)
...
Division = Button(cal, padx=16, pady=16, bd=8, fg='black', font=('arial', 20, 'bold'), text='/', bg='orange', command=lambda:btnClick('/')).grid(row=4, column=3)

#===============================================================

btnClear = Button(cal, padx=120, pady=16, bd=8, fg='black', font=('arial', 20, 'bold'), text='Clear', bg='red', command=btnClearDisplay).grid(row=5, columnspan=4)
cal.mainloop()